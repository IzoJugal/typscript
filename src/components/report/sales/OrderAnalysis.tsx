...
const OrderAnalysis = () => {
    ...
    const handlePreview = async () => {
        try {
            ...
            const response = await apiClient.get(`/category/sales/order-type-wise-analysis${params}`, {
                responseType: "blob",
            });
    ...
    return (
        <div>
            <div>
                {/* Heading */}
                <FormHeaderPaths page={'Order Type Wise Analysis'} prevLink='#' prevPage='Sales' />
            </div>
            <div className="relative max-w-2xl mx-auto p-4 bg-white dark:bg-DARK-800 shadow-md rounded-lg">
                <h2 className="text-2xl font-bold mb-6 text-center dark:text-white">Order Type Wise Analysis</h2>
                    ...
                    <div className="space-y-4">
                        ...
                        {OWNER_ROLES.includes(loginRole) && (<div className="col-span-1">
                            ...
                            <DropdownWithSearch
                                ...
                                fieldKey="restaurant"
                            />
                            {errors.restaurant && <p className="mt-1 text-sm text-ERROR_HOVER">{errors.restaurant}</p>}
                        </div>)}
                        ...
                        <div className="">
                            <label htmlFor="fromDate" className="block text-sm font-medium text-DARK-700 mb-1 dark:text-DARK-200">Order Type</label>
                            {/* <select
                                name="type"
                                value={formData?.type}
