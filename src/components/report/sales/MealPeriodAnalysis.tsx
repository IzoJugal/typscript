...
const MealPeriodAnalysis = () => {
    ...
    const handlePreview = async () => {
        try {
            ...
            const response = await apiClient.get(`/category/sales/meal-period-wise-analysis${params}`, {
                responseType: "blob",
            });
    ...
    return (
        <div>
            <div>
                {/* Heading */}
                <FormHeaderPaths page={'Meal Period Wise Analysis'} prevLink='#' prevPage='Sales' />
            </div>
            <div className="relative max-w-2xl mx-auto p-4 bg-white dark:bg-DARK-800 shadow-md rounded-lg">
                <h2 className="text-2xl font-bold mb-6 text-center dark:text-white">Meal Period Wise Analysis</h2>
                <form className="space-y-4">
                    ...
                    <div className="flex justify-between">
                        <div className="flex items-center gap-2">
                            <Checkbox className="checked:!bg-BRAND-500 !ring-0" id="showNotes" name="showNotes" />
                            <Label htmlFor="showNotes">Active Period Only</Label>
                        </div>
                    </div>
                    <div>
            ...
            <Modal size="7xl" show={openModal} onClose={() => setOpenModal(false)} className="backdrop-blur-sm dark:bg-DARK-950">
                <Modal.Header>Meal Period Wise Analysis</Modal.Header>
                <Modal.Body>
...
export default MealPeriodAnalysis